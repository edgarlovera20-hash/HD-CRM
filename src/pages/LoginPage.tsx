...
export default function LoginPage() {
  ...
  const [email, setEmail] = useState("crm@heavenlydreams.com.mx");
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0A0F1C] px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-[#9CA3AF] mt-2 text-sm">Gestión de clientes y cobranza</p>
        </div>
        ...
        >
          ...
          <div className="mb-4">
            ...
            <input
              ...
              placeholder="crm@heavenlydreams.com.mx"
            />
          </div>
